...
/* package */class SmoothStreamingRendererBuilder implements RendererBuilder,
	...
	public SmoothStreamingRendererBuilder(BaseCastPlayerActivity playerActivity,
	...
	public void buildRenderers(RendererBuilderCallback callback) {
		...
		manifestFetcher = new ManifestFetcher<SmoothStreamingManifest>(parser,
				contentId, url + "/Manifest", userAgent);
	...
	public void onManifest(String contentId, SmoothStreamingManifest manifest) {
		...
		DataSource videoDataSource = new UriDataSource(userAgent,
				bandwidthMeter);
		ChunkSource videoChunkSource = new SmoothStreamingChunkSource(
				manifestFetcher, videoStreamElementIndex, videoTrackIndices,
		...
		DataSource audioDataSource = new UriDataSource(userAgent,
				bandwidthMeter);
		ChunkSource audioChunkSource = new SmoothStreamingChunkSource(
				manifestFetcher, audioStreamElementIndex, new int[] { 0 },
